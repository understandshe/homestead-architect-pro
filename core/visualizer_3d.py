...
class Visualizer3D:
    ...
    def create(self, layout: Dict[str, Any]):
        ...
        # परतों (Layers) को जोड़ना - पुराने फंक्शन
        ...
        # नया फीचर: 3D लेबल्स (मॉडल्स के ऊपर नाम)
        ...
        fig.update_layout(
            ...
            # नया फीचर: HUD/Title छुपाने के लिए बटन
            updatemenus=[
                dict(
                    type="buttons",
                    direction="left",
                    ...
                    buttons=[
                        dict(
                            label="📊 Show Info",
                            method="relayout",
                            args=[{"title.text": f"🏡 {loc_name} — {acres:.2f} acres"}]
                        ),
                        dict(
                            label="🚫 Hide Info",
                            method="relayout",
        ...
        # 1. Plotly चार्ट दिखाना
        st.plotly_chart(fig, use_container_width=True)
        
        # 2. नया फीचर: HTML डाउनलोड बटन
        try:
    ...
    def _add_3d_labels(self, fig, layout):
        """मॉडल्स के ऊपर टेक्स्ट लेबल्स जोड़ना।"""
        ...
        livestock_map = {
            ...
            'fish_tanks': '🐟 Fish Pond', 'bee_hives': '🐝 Bee Hives'
        }
    ...
    # ── Geometry primitives (पुराने फंक्शन - बिना बदलाव के) ──
